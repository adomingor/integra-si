...
class IdentidadGeneroController extends Controller
{
    ...
    {
        $request->getSession()->set("icoNombre", "<i class='fa fa-plus fa-2x isi_iconoIdentGenero' aria-hidden='true'></i>&nbsp;<i class='fa fa-transgender-alt fa-2x isi_iconoIdentGenero' aria-hidden='true'></i>");
