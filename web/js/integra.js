            ...
            .done(function( data ) {
                ...
                if (!$.trim(data) == 0) {
                    ...
                    if (data[0].imagen.trim().length > 0)
                        $("#isi_imgUsr").html("<img class='media-object card-img-top mx-auto' src='data:;base64, " + data[0].imagen.trim() + "'/>");
                    else
                        $('#isi_imgUsr').html("<img class='media-object card-img-top mx-auto' src='" + $img +"'/>");
                }
                else {
                    $('#isi_imgUsr').html("<img class='media-object card-img-top mx-auto' src='" + $img +"'/>");
